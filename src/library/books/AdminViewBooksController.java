...
public class AdminViewBooksController implements Initializable {
    ...
    @FXML
    private TableColumn<Books, JFXButton> removeCol;
    @FXML
    private TableColumn<Books, JFXButton> orderCol;
    ...
    private void initCol() {
        ...
        removeCol.setCellValueFactory(new PropertyValueFactory<>("removeBookBtn"));
